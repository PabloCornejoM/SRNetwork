...
def main():
    ...
    # Model configuration
    input_size = 2  # Nguyen-10 is a single input function
    output_size = 1
    num_layers = 2
    nonlinear_info = [(2, 0), (0, 0), (0, 0)]

    # Get data loaders using the new utility function
    train_loader, val_loader = get_nguyen_data_loaders('Nguyen-10', batch_size=64)
    
    # Get the full dataset for plotting
    X, y = generate_nguyen_data('Nguyen-10')
